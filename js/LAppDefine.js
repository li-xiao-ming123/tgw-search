var LAppDefine = {
  ...
  MODELS: [
    [
      "model/mutsumi/338_casual-2023.model.json",
      "model/mutsumi/338_school_summer-2023.model.json",
      "model/mutsumi/338_school_winter-2023.model.json",
    ],
    [
      "model/sakiko/341_casual-2023.model.json",
      "model/sakiko/341_jh_school_winter-2023.model.json",
      "model/sakiko/341_school_summer-2023.model.json",
      "model/sakiko/341_school_winter-2023.model.json",
    ],
  ],
};
